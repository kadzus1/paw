...
require_once $conf->_ROOT_PATH.'/app/calc_form.php';
require_once $conf->_ROOT_PATH.'/app/calc_result.php';
...
public function spr(){
    ...
    public function widok(){
        ...
        $smarty->assign('page_description','Kalkulator z szablonem, smarty oraz obiektowy');
        ...
        $smarty->display($this->conf->_ROOT_PATH.'/app/calc_view.php');
    }
